...
def parse_args():
    ...
    parser.add_argument(
        ...
        "--output",
        default="",
        help="Arquivo XLSX de saida. Se vazio, salva em entrada/dax_orcamentos_tratado_power_automate_<timestamp>.xlsx.",
    )
    parser.add_argument(
        "--timestamp",
        default="",
...
def main():
    ...
    output_path = (
        ...
        if args.output
        else (Path.cwd() / "entrada" / f"dax_orcamentos_tratado_power_automate_{timestamp}.xlsx")
    )
